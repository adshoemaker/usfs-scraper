...
FORESTS = [
    ...
    {"name": "Idaho Panhandle National Forests",      "code": "idaho-panhandle",    "state": "ID"},
    {"name": "Nez Perce-Clearwater National Forests", "code": "nezperce-clearwater","state": "ID"},
    {"name": "Boise National Forest",                 "code": "boise",              "state": "ID"},
    {"name": "Caribou-Targhee National Forests",      "code": "caribou-targhee",    "state": "ID"},
    {"name": "Payette National Forest",               "code": "payette",            "state": "ID"},
    {"name": "Salmon-Challis National Forest",        "code": "salmon-challis",     "state": "ID"},
    {"name": "Sawtooth National Forest",              "code": "sawtooth",           "state": "ID"},
    ...
    {"name": "Six Rivers National Forest",            "code": "sixrivers",         "state": "CA"},
    {"name": "Shasta-Trinity National Forest",        "code": "shasta-trinity",    "state": "CA"},
    {"name": "Klamath National Forest",               "code": "klamath",           "state": "CA+OR"},
    {"name": "Mendocino National Forest",             "code": "mendocino",         "state": "CA"},
    {"name": "Lassen National Forest",                "code": "lassen",            "state": "CA"},
    {"name": "Modoc National Forest",                 "code": "modoc",             "state": "CA"},
    {"name": "Plumas National Forest",                "code": "plumas",            "state": "CA"},
    {"name": "Tahoe & Eldorado National Forests",     "code": "tahoe-eldorado",    "state": "CA"},
    {"name": "Stanislaus National Forest",            "code": "stanislaus",        "state": "CA"},
    {"name": "Sierra National Forest",                "code": "sierra",            "state": "CA"},
    {"name": "Inyo National Forest",                  "code": "inyo",              "state": "CA"},
    {"name": "Sequoia National Forest",               "code": "sequoia",           "state": "CA"},
    {"name": "Los Padres National Forest",            "code": "lospadres",         "state": "CA"},
    {"name": "Southern CA National Forests",          "code": "socal",             "state": "CA"},
...
FOREST_CODE_TO_ABBREV = {
    ...
    "giffordpinchot":      "GPNF",
    "colville":            "Colville",
    "idaho-panhandle":     "Idaho Panhandle",
    "nezperce-clearwater": "Nez Perce-Clearwater",
    "boise":               "Boise",
    "caribou-targhee":     "Caribou-Targhee",
    "payette":             "Payette",
    "salmon-challis":      "Salmon-Challis",
    "sawtooth":            "Sawtooth",
    "rogue-siskiyou":      "RRS",
...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── Forest summary ── */
        .forest-summary { background: #c8d9c7; border-bottom: 1px solid var(--border); padding: 10px 20px; }
        .forest-summary-inner { position: relative; }
