...
FORESTS = [
    ...
    {"name": "Boise & Payette NFs",       "code": "boise-payette",      "state": "ID"},
    {"name": "Caribou-Targhee NFs",       "code": "caribou-targhee",    "state": "ID"},
    {"name": "Salmon-Challis NF",         "code": "salmon-challis",     "state": "ID"},
    {"name": "Sawtooth NF",               "code": "sawtooth",           "state": "ID"},
    ...
    {"name": "Tahoe & Eldorado NFs",      "code": "tahoe-eldorado",     "state": "CA"},
    {"name": "Stanislaus NF",             "code": "stanislaus",         "state": "CA"},
    {"name": "Sierra NF",                 "code": "sierra",             "state": "CA"},
    {"name": "Inyo & Sequoia NFs",        "code": "inyo-sequoia",       "state": "CA"},
    {"name": "Los Padres NF",             "code": "lospadres",          "state": "CA"},
    {"name": "Southern CA NFs",           "code": "socal",              "state": "CA"},
    {"name": "Chugach NF",                "code": "chugach",            "state": "AK"},
    {"name": "Tongass NF",                "code": "tongass",            "state": "AK"},
]
